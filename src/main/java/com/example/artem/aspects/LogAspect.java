package com.example.artem.aspects;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.example.artem.controller.AdminController.addEvent(..))")
    ...
    @Pointcut("execution(* com.example.artem.controller.AdminController.changeEvent(..))")
    ...
    @Pointcut("execution(* com.example.artem.controller.AdminController.deleteEvent(..))")
    ...
    @Pointcut("execution(* com.example.artem.controller.AdminController.deleteReview(..))")
    ...
    @Pointcut("execution(* com.example.artem.controller.ReviewsController.addReview(..))")
    ...
    @Pointcut("execution(* com.example.artem.controller.AuthController.auth(..))")
    ...
    @Pointcut("execution(* com.example.artem.controller.AuthController.registerUser(..))")
